...
public class TestEmptyPartition extends TestObjectStorageBaseSink {
	...
	public void prepareTest() {
		_testInstance = new TestEmptyPartition();
	}
	...
	public void testS3ABasicAuthSchema() throws Exception {
		String testName = Constants.S3A + TestEmptyPartition.class.getName();
	...
	public void testSwift2d() throws Exception {
		String testName = Constants.SWIFT2D + TestEmptyPartition.class.getName();
