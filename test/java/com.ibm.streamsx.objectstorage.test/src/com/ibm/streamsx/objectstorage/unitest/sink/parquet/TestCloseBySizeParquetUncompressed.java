 ...
 *
 */
public class TestCloseBySizeParquetUncompressed extends TestObjectStorageBaseSink {
	...
	@Test
	public void testCloseBySizeParquetConfigUncompressed() throws Exception {
		runUnitest();
	}
