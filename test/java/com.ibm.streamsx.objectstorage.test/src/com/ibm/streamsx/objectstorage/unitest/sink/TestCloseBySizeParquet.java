 ...
 *
 */
public class TestCloseBySizeParquet extends TestObjectStorageBaseSink {

	public TestCloseBySizeParquet() {
		super();
	}
	...
	public void genTestSpecificParams(Map<String, Object> params) throws UnsupportedEncodingException {
		...
		String objectName = _protocol + TestCloseBySizeParquet.class.getSimpleName() + "%OBJECTNUM." + storageFormat; 
