 ...
 *
 */
public class TestCloseByTupleCountParquetPartitionVar extends BaseObjectStorageTestSink {
	...
	@Test
	public void testCloseByTupleCountParquetPartitionVar() throws Exception {
		runUnitest();
	}
