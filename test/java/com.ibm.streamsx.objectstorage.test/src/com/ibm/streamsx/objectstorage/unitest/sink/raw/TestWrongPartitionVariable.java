 ...
 *
 */
public class TestWrongPartitionVariable extends TestObjectStorageBaseSink {

	private static final String OUT_EXTENSION = "parquet";

	public TestWrongPartitionVariable() {
		super();		
	}
	...
	public void genTestSpecificParams(Map<String, Object> params) throws UnsupportedEncodingException {
		...
		String objectName = _outputFolder + "%PARTITION%TIME_dataHistorian_%OBJECTNUM." + OUT_EXTENSION; 
