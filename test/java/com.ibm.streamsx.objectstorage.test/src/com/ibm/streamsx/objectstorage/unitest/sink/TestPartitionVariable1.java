 ...
 *
 */
public class TestPartitionVariable1 extends TestObjectStorageBaseSink {

	private static final String OUT_EXTENSION = "parquet";

	public TestPartitionVariable1() {
		super();		
	}
	
	@Before
	public void prepareTest() {
		_testInstance = new TestPartitionVariable1();
	}
	...
	public void testCOSBasicAuthSchema() throws Exception {
		String testName = Constants.COS + TestPartitionVariable1.class.getName();		
