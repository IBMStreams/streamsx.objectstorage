...
This allowed to inherit some of [HDSF Toolkit](https://github.com/IBMStreams/streamsx.hdfs) logic.
...
unique for COS. Also, the diagram represents two different clients which utilized 
by the toolkit:
